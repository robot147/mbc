...
public class Pager {
	// 페이지당 게시물 수
		...
		private int curPage;	// 현재 페이지 -> jsp 넘어온 페이지의 위치
		private int prevPage;	// 이전 페이지 -> curpage-1
		private int nextPage; 	// 다음 페이지 -> curpage+1
		private int	totPage;	// 전체 페이지 갯수 -> sql 얻어오고
		private int totBlock;	// 전체 페이지 블록 갯수 ->  totpage/5
...
//			=================================
			...
			public void setTotBlock() {				totBlock=(int)Math.ceil(totPage / BLOCK_SCALE);
			}
